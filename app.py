...
with tab_history:
    ...
    history_section = st.radio("Section", ["Champions", "Head-to-Head", "Record Book", "All-Time Stars", "Draft History", "Team History"],
    ...
    elif history_section == "All-Time Stars":
        ui_components.render_all_time_stars(history_data)
